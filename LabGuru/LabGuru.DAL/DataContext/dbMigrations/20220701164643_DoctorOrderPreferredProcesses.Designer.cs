...
namespace LabGuru.DAL.DataContext.dbMigrations
{
    ...
    [Migration("20220701164643_DoctorOrderPreferredProcesses")]
    partial class DoctorOrderPreferredProcesses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LabGuru.BAL.DoctorOrderPreferredProcess", b =>
                {
                    b.Property<int>("DoctorOrderPeferredProcessID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("DoctorOrderPeferredProcessID");

                    b.HasIndex("OrderID");

                    b.HasIndex("ProcessID");

                    b.ToTable("DoctorOrderPreferredProcesses");
                });
            ...
            modelBuilder.Entity("LabGuru.BAL.OrderDetailsByEmployeeProcess", b =>
                {
                    b.Property<int>("EmployeeOrderProcessID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OrderProcessStatus")
                        .HasColumnType("int");
                    ...
                    b.HasKey("EmployeeOrderProcessID");

                    b.ToTable("OrderDetailsByEmployeeProcess");
                });

            modelBuilder.Entity("LabGuru.BAL.OrderImpression", b =>
                {
                    b.Property<int>("OrderImpressionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("OrderImpressionID");

                    b.HasIndex("OrderID");

                    b.ToTable("OrderImpressions");
                });
            ...
            modelBuilder.Entity("LabGuru.BAL.ProcessStatus", b =>
                {
            ...
            modelBuilder.Entity("LabGuru.BAL.Login", b =>
                {
                    b.HasOne("LabGuru.BAL.Role", "Roles")
                        .WithMany()
